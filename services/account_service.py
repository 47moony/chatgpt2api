...
class AccountService:
    ...
    def _request_access_token_refresh(self, refresh_token: str, account: dict | None = None) -> dict[str, str]:
        ...
        oauth = account.get("oauth") if isinstance(account, dict) and isinstance(account.get("oauth"), dict) else {}
    ...
    def refresh_accounts(
        ...
        *,
        ...
        if not access_tokens:
            ...
            if progress_id and finish_progress:
        ...
        try:
            ...
            for future in as_completed(futures):
                ...
                try:
                    ...
                    errors.append({"access_token": token, "token": anonymize_token(token), "error": str(exc)})
                    continue
                if account is not None:
                    refreshed += 1

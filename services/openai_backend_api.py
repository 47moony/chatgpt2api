...
class OpenAIBackendAPI:
    ...
    def _resolve_image_urls(self, conversation_id: str, file_ids: list[str], sediment_ids: list[str]) -> list[str]:
        ...
        # Prefer the conversation attachment pointer first. ChatGPT image tool
        # events may expose both sediment:// and file-service:// for one output;
        # sediment is more likely to be the original-size asset, while
        # file-service can be a normalized 1024px copy.
        if conversation_id:
